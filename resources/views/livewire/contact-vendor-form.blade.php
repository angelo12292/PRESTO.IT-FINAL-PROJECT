<div>
  ...
  <form class="mt-3" wire:submit="store">
    <div class="mb-3">
      ...
      <textarea type="text" wire:model="body" class="form-control p-0 @error('body') is-invalid @enderror" id="body"
        placeholder="  Scrivi al venditore" style="height: 200px"></textarea>
