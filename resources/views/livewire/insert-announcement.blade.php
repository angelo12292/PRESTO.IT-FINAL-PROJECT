        ...
        <div class="row">
          <div class="col-6 m-auto mt-2 ">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('AnnTitle') is-invalid @enderror" id="title"
                placeholder="{{__('ui.insertPlaceTitle')}}" wire:model="AnnTitle">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control @error('AnnPrice') is-invalid @enderror" id="price"
                placeholder="{{__('ui.insertPrice')}}" wire:model="AnnPrice">
              ...
              <div class="col-12">
                ...
                <div class="row border border-4 border-info rounded shadow-sm  py-4 ">
                  ...
                  <div class="col my-3 text-center ">
                    ...
                    <button type="button" class="btn btn-danger shadow-sm d-block text-center mt-2 mx-auto"
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control @error('AnnDescrip') is-invalid @enderror" id="description" rows="3"
                wire:model="AnnDescrip">

                </textarea>
              @error('AnnDescrip') <span class="text-danger small">{{ $message }}</span> @enderror
            </div>
            <div class="mb-3" wire:loading.remove>
              <button class="btn text-white rounded-5  primary-color-bg btnStatic" wire:click="announcementCreated"
                wire:target="updatedTemporaryImages" type="submit">{{__('ui.btnCreate')}}</button>
            </div>
          </div>
        </div>
      </form>
